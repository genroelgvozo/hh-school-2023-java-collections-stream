...
public class Task3 {
  ...
  public static List<Person> sort(Collection<Person> persons) {
    ...
    return sortedList;
      ...
      // сложность по времени - O(n * logN * logN) ( logN - добавление элементов в сортированную таблицу по величине CreatedAt и getSecondName и для каждого getFirstName которых n)
      // сложность по памяти - O(n) ( поле ЗНАЧЕНИЕ в списке )

    // не потерять - мануал откуда брал
